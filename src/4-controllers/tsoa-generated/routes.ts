...
const models: TsoaRoute.Models = {
  Facility: {
    dataType: "refObject",
    properties: {
      _instanceSeq: { dataType: "double", required: true },
...
export function RegisterRoutes(app: express.Router) {
  ...
  app.post(
    ...
    authenticateMiddleware([{ CONSOLE_TENANT: [] }]),
    function FacilityAPI_registerFacilityGMO(
      request: any,
      response: any,
      next: any
    ) {
      ...
      const promise = controller.registerFacilityGMO.apply(
        controller,
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  app.get(
    "/tenants/:tenantId/facilities/:tenantId/facilities",
    authenticateMiddleware([{ CONSOLE_TENANT: [] }]),
    function FacilityAPI_listFacilities(
      request: any,
      response: any,
      next: any
    ) {
      ...
      const promise = controller.listFacilities.apply(
        controller,
        validatedArgs as any
      );
      promiseHandler(controller, promise, response, undefined, next);
  ...
  app.patch(
    ...
    function TenantAPI_updateName(request: any, response: any, next: any) {
      ...
      const promise = controller.updateName.apply(
        controller,
        validatedArgs as any
      );
      promiseHandler(controller, promise, response, undefined, next);
  ...
  app.patch(
    ...
    function TenantAPI_updateCode(request: any, response: any, next: any) {
      ...
      const promise = controller.updateCode.apply(
        controller,
        validatedArgs as any
      );
      promiseHandler(controller, promise, response, undefined, next);
